...
namespace FotoCel
{
    [Activity(Label = "Dorezuar")]
    public class DorezuarActivity : Activity
    {
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.DorezuarReport);
            ...
            var caller4 = new RestSharpCaller("http://webapisignalr20180319052628.azurewebsites.net/api/Dorzo/?driverId=" + Settings.GeneralSettingsPass + "&data=" + DataZgjedhur.data);
            ...
            pickupNr.Text = "Dorezuar : " + orders.Count().ToString();
