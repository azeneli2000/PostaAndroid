...
namespace FotoCel
{
    [Activity(Label = "Konfirmuar")]
    public class PareActivity : Activity
    {
       public List<Order> orders = new List<Order>();
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.PareReport);
            ...
            var caller4 = new RestSharpCaller("http://webapisignalr20180319052628.azurewebsites.net/api/Pare/?driverId=" + Settings.GeneralSettingsPass + "&data=" + DataZgjedhur.data);
            ...
            pickupNr.Text = "Konfirmuar : " + orders.Count().ToString();
