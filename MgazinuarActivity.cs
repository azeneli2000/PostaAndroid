...
namespace FotoCel
{
    [Activity(Label = "Magazinuar")]
    public class MgazinuarActivity : Activity
    {
       public List<Order> orders = new List<Order>();
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Magazinuar);
            ...
            var caller4 = new RestSharpCaller("http://webapisignalr20180319052628.azurewebsites.net/api/Magazinuar/?driverId=" + Settings.GeneralSettingsPass + "&data=" + DataZgjedhur.data);
            ...
            pickupNr.Text = "Magazinuar : " + orders.Count().ToString();
